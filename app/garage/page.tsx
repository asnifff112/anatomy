      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6 border-b border-white/5 pb-10">
          ...
          <div className="flex gap-4">
            <button onClick={() => router.push("/change-password")} className="px-5 py-2 border border-white/10 text-[10px] font-bold uppercase text-zinc-400 hover:text-white transition-all">Change_Key</button>
            <button onClick={async () => { await logout(); router.push("/login"); }} className="px-5 py-2 bg-red-600/10 border border-red-500/20 text-[10px] font-bold uppercase text-red-500 hover:bg-red-600 hover:text-white transition-all">Terminiate_Session</button>
          </div>
        </div>
